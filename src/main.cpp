...
int main(int, char**) {
    ...
    std::ifstream input_file (data_path, std::ios::in | std::ios::binary);
    if (input_file.is_open()) {
        ...
        std::cout << "[ERROR]: unable to open file to read" << std::endl;
        exit(1);
    }

    BlockManager manager(disk);

    bool initialize = manager.getIni();
    ...
    while(true) {
        ...
        if(argc == 0) {
        ...
        else if(strcmp(argv[0], "changeDir") == 0) {
            if(argc != 2) {
        ...
        else if(strcmp(argv[0], "createDir") == 0) {
            if(argc != 2) {
        ...
        else if(strcmp(argv[0], "deleteFile") == 0) {
            if(argc == 2) {
                if(strlen(argv[1]) >= 2048) {
                    std::cout<<"path length exceed limit"<<std::endl;
                }
                ...
                std::cout<<"deleteFile: arguments number is wrong"<<std::endl;
            }
        }
        else if(strcmp(argv[0], "deleteDir") == 0) {
            if(argc == 2) {
                if(strlen(argv[1]) >= 2048) {
                    std::cout<<"path length exceed limit"<<std::endl;
                }
            ...
            if(argc != 2) {
                std::cout<<"cat: arguments number is wrong"<<std::endl;
            }
            else {
            ...
            if(argc != 1) {
                std::cout<<"sum: arguments number is wrong"<<std::endl;
            }
            else {
                fs.usage();
            }
    ...
    output_file.open(data_path, std::ios::out | std::ios::binary );
    if (output_file.is_open()) {
        ...
        std::cout << "[ERROR]: unable to open file to write" << std::endl;
    }
}
